...
function nuevosComodines() {
    ...
    const listaComodin = [
        0, 1, 2, 3, 4, 5, 6, 7, 4, 5, 6, 7, 4, 5, 6, 7, 0, 1, 2, 3, 0, 1, 2, 3, 4, 5, 6, 7, 4, 5, 6, 7, 4, 5, 6, 7, 0, 1, 2, 3, 0, 1, 2, 3, 8, 4, 5, 6, 7, 4, 5, 6, 7, 4, 5, 6, 7, 0, 1, 2, 3,
    ];
    const numeroComodin = listaComodin[getRandom(0, length(listaComodin))];
    // const numeroComodin = 5;
    update(Mundo, (Mundo.comodines[numeroComodin].tiempoActivo = getRandom(40, 60)));
