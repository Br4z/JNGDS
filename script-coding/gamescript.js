...
function drawGame(Mundo) {
    ...
    if (Mundo.comodines[1].tiempoActivo > 0) {
        image(invencibilidad, Mundo.comodines[1].x * 20, Mundo.comodines[1].y * 20, lado, lado);
    }

    if (Mundo.comodines[2].tiempoActivo > 0) {
        image(aumentoPuntos, Mundo.comodines[2].x * 20, Mundo.comodines[2].y * 20, lado, lado);
    }
    if (Mundo.comodines[3].tiempoActivo > 0) {
        image(aumentoVida, Mundo.comodines[3].x * 20, Mundo.comodines[3].y * 20, lado, lado);
    }
    if (Mundo.comodines[4].tiempoActivo > 0) {
        image(invertir, Mundo.comodines[4].x * 20, Mundo.comodines[4].y * 20, lado, lado);
    }
    if (Mundo.comodines[5].tiempoActivo > 0) {
        image(tombos, Mundo.comodines[5].x * 20, Mundo.comodines[5].y * 20, lado, lado);
    }
    if (Mundo.comodines[6].tiempoActivo > 0) {
        image(reduccionPuntos, Mundo.comodines[6].x * 20, Mundo.comodines[6].y * 20, lado, lado);
    }
    if (Mundo.comodines[7].tiempoActivo > 0) {
        // NO ESTA
        image(golpeAccionado, Mundo.comodines[7].x * 20, Mundo.comodines[7].y * 20, lado, lado);
    }
    if (Mundo.comodines[8].tiempoActivo > 0) {
        image(aleatorio, Mundo.comodines[8].x * 20, Mundo.comodines[8].y * 20, lado, lado);
    }

    //DIBUJA COMIDAS
    if (Mundo.comidas[0].tiempoActivo > 0) {
        image(pegantes, Mundo.comidas[0].x * 20, Mundo.comidas[0].y * 20, lado, lado);
    }
    ...
    if (Mundo.comidas[2].tiempoActivo > 0) {
        image(chontaduros, Mundo.comidas[2].x * 20, Mundo.comidas[2].y * 20, lado, lado);
    }
    if (Mundo.comidas[3].tiempoActivo > 0) {
        image(gaseosa, Mundo.comidas[3].x * 20, Mundo.comidas[3].y * 20, lado, lado);
    }
}
...
function onTic(Mundo) {
    ...
    } else if (comerItem(Mundo.snake, Mundo.comodines[8]) || Mundo.comodines[8].tiempoAccionado > 0) {
        //(Hexadecimal xd)
        accionAleatorio();
    }
    ...
    if (
        ...
        (choqueSnake(rest(Mundo.snake), Mundo.snake[0]) == true && invencibilidad == true && Mundo.lives >= 1)
