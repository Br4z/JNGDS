...
(function () {
    ...
    keypress.Listener = (function () {
        function Listener(element, defaults) {
            ...
            this.keydown_event = attach_handler(
                this.element,
                "keydown",
                (function (_this) {
                    return function (e) {
            ...
            this.keyup_event = attach_handler(
                this.element,
                "keyup",
                (function (_this) {
                    return function (e) {
            ...
            this.blur_event = attach_handler(
                window,
                "blur",
                (function (_this) {
                    return function () {
        ...
        Listener.prototype._bug_catcher = function (e) {
            ...
            if (
                _metakey === "cmd" &&
                __indexOf.call(this._keys_down, "cmd") >= 0 &&
                (_ref = _convert_key_to_readable((_ref1 = e.keyCode) != null ? _ref1 : e.key)) !== "cmd" &&
                _ref !== "shift" &&
                _ref !== "alt" &&
                _ref !== "caps" &&
                _ref !== "tab"
        ...
        Listener.prototype._get_active_combos = function (key) {
            ...
            this._fuzzy_match_combo_arrays(
                keys_down,
                (function (_this) {
                    return function (match) {
        ...
        Listener.prototype._match_combo_arrays = function (potential_match, match_handler) {
            ...
            for (_i = 0, _len = _ref.length; _i < _len; _i++) {
                ...
                if (
                    (!source_combo.is_unordered && _compare_arrays_sorted(combo_potential_match, source_combo.keys)) ||
                    (source_combo.is_unordered && _compare_arrays(combo_potential_match, source_combo.keys))
                ) {
        ...
        Listener.prototype._fuzzy_match_combo_arrays = function (potential_match, match_handler) {
            ...
            for (_i = 0, _len = _ref.length; _i < _len; _i++) {
                source_combo = _ref[_i];
                if (
                    (!source_combo.is_unordered && _is_array_in_array_sorted(source_combo.keys, potential_match)) ||
                    (source_combo.is_unordered && _is_array_in_array(source_combo.keys, potential_match))
                ) {
                    match_handler(source_combo);
                }
            }
